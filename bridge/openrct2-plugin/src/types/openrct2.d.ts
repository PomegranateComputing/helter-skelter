// Vendored verbatim from the OpenRCT2 v0.5.3 release tarball's doc/openrct2.d.ts
// (github.com/OpenRCT2/OpenRCT2, GPL-3.0, commit f503f57bdb74b31507f83909db587a5db5794ef0).
// This file is the plugin API this bridge is written against -- see
// docs/OPENRCT2_INTEGRATION.md. Do not hand-edit; replace wholesale when
// bumping the pinned OpenRCT2 version in scripts/bootstrap/setup-openrct2.sh.
